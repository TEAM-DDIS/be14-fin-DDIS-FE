...
function saveEdit(updated) {
  ...
  if (idx !== -1) {
    ...
    // 예:
    // await fetch(`https://ddis-be-alb-1219702514.ap-northeast-2.elb.amazonaws.com/org/update/department/${updated.departmentId}`, {
    //   method: 'PUT',
...
onMounted(async () => {
  try {
    // 실제 백엔드 주소에 맞춰 수정하세요 (예: https://ddis-be-alb-1219702514.ap-northeast-2.elb.amazonaws.com)
